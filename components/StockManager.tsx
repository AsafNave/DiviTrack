        ...
        <div className="flex items-center gap-2" onTouchStart={(e) => e.stopPropagation()}>
            <div className="relative">
                ...
                <input 
                  ...
                  className="w-20 bg-slate-800 border border-slate-700 rounded-lg py-2 pl-6 pr-3 text-sm text-right text-slate-300 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 outline-none"
                  placeholder="Qty"
                />
            </div>
        </div>
